                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form onSubmit={handleSubmit} className='my-10'>
                                        <div className='mb-5'>
                                            <label className="text-gray-700 uppercase text-sm font-bold" htmlFor='nombre'>Nombre Tarea</label>
                                            <input 
                                                type="text" 
                                                id='nombre'
                                        ...
                                        <div className='mb-5'>
                                            <label className="text-gray-700 uppercase text-sm font-bold" htmlFor='decripcion'>Descripción</label>
                                            <textarea
                                                id='descripcion'
                                        ...
                                        <div className='mb-5'>
                                            <label className="text-gray-700 uppercase text-sm font-bold" htmlFor='fecha-entrega'>Fecha de Entrega</label>
                                            <input 
                                                type="date" 
                                                id='fecha-entrega'
                                                className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md'
                                        ...
                                        <div className='mb-5'>
                                            <label className="text-gray-700 uppercase text-sm font-bold" htmlFor='prioridad'>Nombre Tarea</label>
                                            <select
                                                id='prioridad'
                                                className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md'
                                                value={prioridad}
